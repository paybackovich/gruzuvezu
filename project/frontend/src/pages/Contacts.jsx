  ...
  return (
    <div className="mx-auto w-full max-w-6xl space-y-10 px-4 py-10 sm:px-6">
      <div className="space-y-4">
        ...
        <h1 className="text-4xl font-bold text-slate-900">Свяжитесь с нами</h1>
        <p className="text-base text-slate-600">
          Ответим на вопросы по перевозке, стоимости и условиям сотрудничества.
        </p>
      </div>
      ...
      <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
        <div className="space-y-6 rounded-3xl border border-slate-200 bg-white p-6 shadow-soft">
          <div>
            <p className="text-sm uppercase tracking-widest text-blue-600">Телефон</p>
        ...
        >
          <div className="space-y-2">
            ...
            <p className="text-sm text-slate-500">Оставьте контакты — перезвоним в течение рабочего часа.</p>
          </div>
          ...
          <FormField id="message" label="Сообщение" required>
            <textarea
              ...
              placeholder="Опишите задачу, маршрут и сроки."
              value={form.message}
              onChange={handleChange}
              required
            />
          ...
          {sent && (
            <div className="rounded-2xl border border-green-100 bg-green-50 px-4 py-3 text-sm text-green-700">
              Сообщение принято. Перезвоним в ближайшее время.
            </div>
          )}
        </form>
      </div>
